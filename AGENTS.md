...
For implementation and review tasks, use the repository skill at `.agents/skills/tarvaultsync-development`. Its canonical source is `skills/tarvaultsync-development`; the `.agents/skills` path exists so Codex discovers it automatically.
